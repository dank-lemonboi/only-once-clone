  ...
  constructor() {
    ...
    render() {
        ...
        return <div className="image-carousel">
            <div id="animate-me">
              <ImageSlide url='https://s3.ca-central-1.amazonaws.com/clone-once-photos/braun_radio.jpg' text={imgUrls[0].text} />
            </div>
            <div id="animate-me">
              <ImageSlide url='https://s3.ca-central-1.amazonaws.com/clone-once-photos/lamps.jpg' text={imgUrls[1].text} />
            </div>
            <div id="animate-me">
              <ImageSlide url='https://s3.ca-central-1.amazonaws.com/clone-once-photos/only-once-siemens-fan.jpg' text={imgUrls[2].text} />
            </div>
            {/* <div id="animate-me">
              <ImageSlide url='https://s3.ca-central-1.amazonaws.com/clone-once-photos/oo_slider_clocks.jpg' text={imgUrls[3].text} />
            </div> */}
            <div id='animate-me'>
              <ImageSlide url='https://s3.ca-central-1.amazonaws.com/clone-once-photos/pp-slideshow-1-braun-fan.jpg' text={imgUrls[3].text}/>
            </div>
